...
const products = (state = initialState, action) => {
  switch (action.type) {
    ...
    case Actions.FILTER_PRODUCTS:
      return {...state, productsQuantity: action.payload.productsQuantity, productsByCategory: action.payload.products};
    ...
    case Actions.GET_ALL_PRODUCT_BY_CATEGORY:
      return {...state, productsByCategoryAll: action.payload};
    default:
      return state;
  }
};
